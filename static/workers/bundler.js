!(function () {
	...
	*/ for (
	...
	const Se = 'break case class catch const continue debugger default delete do else export extends finally for function if import in instanceof let new return super switch this throw try typeof var void while with yield enum await implements package protected static interface private public'.split(
			' '
		),
		_e = 'Infinity NaN undefined null true false eval uneval isFinite isNaN parseFloat parseInt decodeURI decodeURIComponent encodeURI encodeURIComponent escape unescape Object Function Boolean Symbol Error EvalError InternalError RangeError ReferenceError SyntaxError TypeError URIError Number Math Date String RegExp Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array Map Set WeakMap WeakSet SIMD ArrayBuffer DataView JSON Promise Generator GeneratorFunction Reflect Proxy Intl'.split(
			' '
		),
	...
	class Ct extends Ee {
		...
		include() {
			this.included ||
				((this.included = !0), this.context.includeVariable(this.syntheticNamespace));
		}
		setRenderNames(e, t) {
	...
	function ss(e, t, s) {
		return {
			...
			message: `"${e}" was specified for "output.exports", but entry module "${Yt(
				s
	...
	function is(e) {
		...
		return {
			...
			message: `Module "${Yt(e.id)}" that should be implicitly loaded before "${
	...
	function ns(e, t, s) {
		return {
			...
			message: `Conflicting namespaces: ${Yt(t.id)} re-exports '${e}' from both ${Yt(
				t.exportsAll[e]
			)} and ${Yt(s.exportsAll[e])} (will be ignored)`,
			name: e,
			reexporter: t.id,
	...
	function rs(e, t, s) {
		...
		return {
			...
			id: e,
			message: `The named export "${t}" was ${i}ed from the external module ${Yt(
				e
	...
	function as(e) {
		return {
			code: es.UNEXPECTED_NAMED_IMPORT,
			id: e,
			message: `There was a namespace "*" reexport from the external module ${Yt(
				e
				...
				`${u}${r}return${p}{${
					g.length
						? `${u}${r}${r}setters:${p}[${g
								.map((e) =>
									e
										? `function${p}(module)${p}{${u}${r}${r}${r}${e}${u}${r}${r}}`
										: c.systemNullSetters
										? 'null'
										: `function${p}()${p}{}`
								)
		...
		umd: function (
				...
				(t =
					...
					(V =
						`(function${_}()${_}{${A}${r}${r}var current${_}=${_}${(function (e, t, s) {
							...
							w,
							_
						)};${A}${r}${r}${t}${A}${r}${r}${e}.noConflict${_}=${_}function${_}()${_}{${_}${xs(
							v,
							w
						)}${_}=${_}current;${_}return ${e}${d ? '' : '; '}};${A}` +
						r +
						'}())');
			...
			const D = n || (b && o) || T.length > 0,
				...
				U =
					...
					(D
						? `${r}typeof exports${_}===${_}'object'${_}&&${_}typeof module${_}!==${_}'undefined'${_}?${_}${$}${C}(${I.join(
								',' + _
						  )})${_}:${A}`
						: '') +
	...
	const ni = {
				...
				if ((this.left.render(e, t), this.right.render(e, t), 'system' === t.format)) {
					...
					if ('Identifier' === this.left.type && s) {
						...
						e.overwrite(
							...
							`=${i}${
								1 === s.length ? `exports('${s[0]}',${i}` : L([this.left.variable], !1, t)
							}${r}`
						),
						...
						this.left.addExportedVariables(s, t.exportNamesByVariable),
							s.length > 0 &&
								(e.prependRight(this.start, L(s, !0, t)), e.appendLeft(this.end, ')'));
					}
				}
			}
		...
		CallExpression: class extends qe {
			...
			bind() {
				super.bind(),
					...
					this.callee instanceof Is &&
						!this.callee.variable &&
						this.callee.object.deoptimizePath(F);
		...
		MetaProperty: class extends qe {
			addAccessedGlobals(e, t) {
				const s = this.metaProperty,
					i = (s && (s.startsWith(Us) || s.startsWith(Ws) || s.startsWith('ROLLUP_CHUNK_URL_'))
						? zs
						: js)[e];
		...
		SwitchStatement: class extends qe {
			...
			hasEffects(e) {
				...
				return (
					null !== this.defaultCase && 1 !== i && (e.brokenFlow = i), (e.ignore.breaks = s), !1
				);
			}
			include(e, t) {
	...
	(hi.Program = hi.BlockStatement = function (e, t, s) {
		for (var i = 0, n = e.body; i < n.length; i += 1) s(n[i], t, 'Statement');
	}),
		(hi.Statement = ai),
		(hi.EmptyStatement = oi),
		(hi.ExpressionStatement = hi.ParenthesizedExpression = hi.ChainExpression = function (e, t, s) {
		...
		(hi.ReturnStatement = hi.YieldExpression = hi.AwaitExpression = function (e, t, s) {
			e.argument && s(e.argument, t, 'Expression');
		}),
		(hi.ThrowStatement = hi.SpreadElement = function (e, t, s) {
		...
		(hi.WhileStatement = hi.DoWhileStatement = function (e, t, s) {
		...
		(hi.ForInStatement = hi.ForOfStatement = function (e, t, s) {
		...
		(hi.UnaryExpression = hi.UpdateExpression = function (e, t, s) {
			s(e.argument, t, 'Expression');
		}),
		(hi.BinaryExpression = hi.LogicalExpression = function (e, t, s) {
			s(e.left, t, 'Expression'), s(e.right, t, 'Expression');
		}),
		(hi.AssignmentExpression = hi.AssignmentPattern = function (e, t, s) {
		...
		(hi.NewExpression = hi.CallExpression = function (e, t, s) {
		...
		(hi.ExportNamedDeclaration = hi.ExportDefaultDeclaration = function (e, t, s) {
			e.declaration &&
				s(
					e.declaration,
					t,
		...
		(hi.ImportSpecifier = hi.ImportDefaultSpecifier = hi.ImportNamespaceSpecifier = hi.Identifier = hi.Literal = oi),
		(hi.TaggedTemplateExpression = function (e, t, s) {
			s(e.tag, t, 'Expression'), s(e.quasi, t, 'Expression');
		}),
		(hi.ClassDeclaration = hi.ClassExpression = function (e, t, s) {
			return s(e, t, 'Class');
		}),
		...
		(hi.MethodDefinition = hi.Property = function (e, t, s) {
				...
				this.syntheticNamespace
					...
					: Jt({
							...
							message: `Module "${Yt(
								...
								'string' == typeof this.syntheticNamedExports &&
								'default' !== this.syntheticNamedExports
					...
					return (
						0 === s.size &&
							...
							this.inputOptions.onwarn({
								code: 'EMPTY_FACADE',
								id: e.id,
								message: `To preserve the export signature of the entry module "${Yt(
									e.id
	...
	var Pr = function (e, t, s) {
			(this.options = e = (function (e) {
				...
				(this.keywords = br(
					qn[e.ecmaVersion >= 6 ? 6 : 'module' === e.sourceType ? '5module' : 5]
				));
			var i = '';
			!0 !== e.allowReserved &&
			...
			for (e.declarations = [], e.kind = s; ; ) {
				...
				if (
					...
					this.eat(cr.eq)
						...
						? 'Identifier' === i.id.type || (t && (this.type === cr._in || this.isContextual('of')))
							? (i.init = null)
							: this.raise(
									this.lastTokEnd,
	...
	(Yr.initialContext = function () {
		...
		(cr.parenR.updateContext = cr.braceR.updateContext = function () {
		...
		(cr._function.updateContext = cr._class.updateContext = function (e) {
			!e.beforeExpr ||
			e === cr._else ||
					...
					: Jt(
							(function (e, t) {
								return {
									...
									message: `'${e}' is imported as an external by ${Yt(
										t
				...
				? Jt(
						null === i
							...
							: (function (e, t) {
									return {
										code: es.MISSING_IMPLICIT_DEPENDANT,
										message: `Module "${Yt(e)}" that should be implicitly loaded before "${Yt(
											t
		...
		return (function (e, t, s) {
			...
			const c = new Set(s),
				...
				f = ((e, t, s) => {
					var i;
					const n =
						(null !== (i = e.preserveModules) && void 0 !== i ? i : s.preserveModules) || !1;
					if (n) {
						if (t)
							return Jt({
								code: 'INVALID_OPTION',
	...
	var dh = function (e, t, s) {
			(this.options = e = uh(e)),
				(this.sourceFile = e.sourceFile),
				(this.keywords = ah(
					Lo[e.ecmaVersion >= 6 ? 6 : 'module' === e.sourceType ? '5module' : 5]
				));
			var i = '';
				...
				if (
					...
					this.eat(Xo.eq)
						...
						: 'const' !== s ||
						  this.type === Xo._in ||
						  (this.options.ecmaVersion >= 6 && this.isContextual('of'))
						? 'Identifier' === i.id.type || (t && (this.type === Xo._in || this.isContextual('of')))
							? (i.init = null)
							: this.raise(
									this.lastTokEnd,
									'Complex binding patterns require an initialization value'
	...
	($h.initialContext = function () {
		...
		(Xo.parenR.updateContext = Xo.braceR.updateContext = function () {
			if (1 !== this.context.length) {
				var e = this.context.pop();
		...
		(Xo._function.updateContext = Xo._class.updateContext = function (e) {
			!e.beforeExpr ||
			e === Xo.semi ||
			e === Xo._else ||
